...
{
   //String* title_1 = one->getKey();  //used for testing with the title of the cd
   //String* title_2 = two->getKey();
   String* title_1 = one->getArtist(); //used for testing with the artist of the cd
   String* title_2 = two->getArtist();
...
{
   String* title_1 = sk;
   //String* title_2 = cd->getKey(); //used for testing with the title of the cd
   String* title_2 = cd->getArtist(); //used for testing with the artist of the cd
   int title_compare = title_1->compare(title_2);  //asc
   return title_compare;
}
